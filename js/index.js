/*    
        resposta[0].  tipos:["salgado 1", "doce 2", "nenhum 0"];

        resposta[1].  preferencias: ["sem gluten 1", "sem lactose 2", "vegana 3", "vegetariano 4", "outros 5", "nenhum 0"];

        resposta[2].  tempos: ["rapido 1", "medio 2", "lento 3", "nenhuma 0"];

        resposta[3].  dificuldades: ["pratico 1", "moderado 2", "dificil 3", "nenhuma 0"];

        resposta[4].  sabores: ["Suave 1", "Médio 2" , "Forte / Intenso 3", "Apimentado 4", "Agridoce 5", "Nenhuma preferência 0"];

        resposta[5].  refeicoes: ["Café da manhã 1", "Lanche 2", "Almoço 3", "Jantar 4", "Sobremesa 5", "Petisco 6"];

        resposta[6].  preparacoes: ["Assado 1", "Frito 2", "Cozido 3", "Grelhado 4", "Cru 5", "Airfryer 6", "Micro-ondas 7"];

        resposta[7].  texturas: ["Crocante 1", "Cremoso 2", "Macio 3", "Seco 4", "Nenhuma 0"];

        resposta[8].  temperatura: ["Quente 1", "Frio 2", "Nenhuma preferência 0"];

        dentro do if.
        nome: nome da refeicao;
        link: o link da refeicao.
*/
